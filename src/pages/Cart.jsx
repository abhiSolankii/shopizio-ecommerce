...
const Cart = () => {
  ...
  const [isCongratulationsVisible, setIsCongratulationsVisible] =
    useState(false);
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 mt-8">
                ...
                <button
                  ...
                  className="w-full py-3 bg-green-500 text-white rounded-full hover:bg-green-600 transition-all text-lg font-semibold"
                >
                  Proceed to Checkout
                </button>
              </div>
